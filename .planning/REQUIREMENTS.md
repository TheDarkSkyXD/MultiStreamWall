...
- [x] **DISC-03**: User can search Twitch live streams via @twurple/api (app credentials in settings)
- [x] **DISC-04**: User can search Kick live streams via direct API fetch (app credentials in settings)
